...
const createMenuTemplate = () => `<h2 class="visually-hidden">Switch trip view</h2>
<nav class="trip-controls__trip-tabs  trip-tabs">
<a class="trip-tabs__btn  trip-tabs__btn--active" href="#">Table</a>
<a class="trip-tabs__btn" href="#">Stats</a>
</nav>`;

const createFiltersTemplate = () => `<h2 class="visually-hidden">Filter events</h2>
...
const createCardTemplate = () => `<li class="trip-events__item">
<div class="event">
...
const createEditCardTemplate = () => `<form class="event event--edit" action="#" method="post">
...
const createDayTemplate = () => `<li class="trip-days__item  day">
<div class="day__info">
